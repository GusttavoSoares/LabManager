...
var connection = new SqliteConnection("Data Source=database.db");  // o var está determinndoa que connection é do tipo SqlliteConnection, portanto não precisa escrever o tipo duas vezes
connection.Open();
